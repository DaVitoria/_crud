            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="assets/img/clieeen.jpg" alt="..." class="img-fluid">
                    <div class="order dashbg-2">1st</div>
                  </div><a href="#" class="user-title">
                    <h3 class="h5">Fidel Mendes</h3><span>@fidelmendes</span></a>
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="assets/img/cliee.jpg" alt="..." class="img-fluid">
                    <div class="order dashbg-1">2nd</div>
                  </div><a href="#" class="user-title">
                    <h3 class="h5">Noemia Maunze</h3><span>@noemiabombe</span></a>
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="assets/img/ceo.jpg" alt="..." class="img-fluid">
                    <div class="order dashbg-4">3rd</div>
                  </div><a href="#" class="user-title">
                    <h3 class="h5">Prisioneiro da Paz</h3><span>@prisioneiro</span></a>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="assets/img/bisd.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
                </div>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="assets/img/jagu.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Shelby</strong><span class="d-block">@tonshelby</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="row d-flex align-items-stretch">
              <div class="col-lg-4">
                <div class="stats-with-chart-1 block">
                  <div class="title"> <strong class="d-block">Estudos Realizados</strong><span class="d-block">Lorem ipsum dolor sit</span></div>
                  <div class="row d-flex align-items-end justify-content-between">
                    <div class="col-5">
                      <div class="text"><strong class="d-block dashtext-3">Mzn7450</strong><span class="d-block">Janeiro 2023</span><small class="d-block">320 Livros</small></div>
                    </div>
                    <div class="col-7">
              ...
              <div class="col-lg-4">   
                <div class="stats-with-chart-1 block">
                  <div class="title"> <strong class="d-block">Estatistica de visitas</strong><span class="d-block">Lorem ipsum dolor sit</span></div>
                  <div class="row d-flex align-items-end justify-content-between">
                    <div class="col-4">
                      <div class="text"><strong class="d-block dashtext-1">Mzn4557</strong><span class="d-block">Fevereiro 2023</span><small class="d-block">210 Visitas</small></div>
                    </div>
                    <div class="col-8">
                      <div class="bar-chart chart">
              ...
              <div class="col-lg-4">
                <div class="stats-with-chart-1 block">
                  <div class="title"> <strong class="d-block">Actividades de venda</strong><span class="d-block">Lorem ipsum dolor sit</span></div>
                  <div class="row d-flex align-items-end justify-content-between">
                    <div class="col-5">
                      <div class="text"><strong class="d-block dashtext-2">80%</strong><span class="d-block">Fevereiro 2023</span><small class="d-block">+35 Vendas</small></div>
                    </div>
                    <div class="col-7">
                      <div class="bar-chart chart">
